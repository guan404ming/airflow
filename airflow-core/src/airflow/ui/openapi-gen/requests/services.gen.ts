...
export class AssetService {
     ...
     * @throws ApiError
     */
    public static getPendingAssetPartitions(data: GetPendingAssetPartitionsData): CancelablePromise<GetPendingAssetPartitionsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/ui/dags/{dag_id}/asset_partitions/pending',
            path: {
                dag_id: data.dagId
            },
            query: {
