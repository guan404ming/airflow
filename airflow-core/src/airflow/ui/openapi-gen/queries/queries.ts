...
* @throws ApiError
*/
export const useAssetServiceGetPendingAssetPartitions = <TData = Common.AssetServiceGetPendingAssetPartitionsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ dagId, limit, offset }: {
  dagId: string;
  limit?: number;
  offset?: number;
}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseAssetServiceGetPendingAssetPartitionsKeyFn({ dagId, limit, offset }, queryKey), queryFn: () => AssetService.getPendingAssetPartitions({ dagId, limit, offset }) as TData, ...options });
/**
* List Backfills
* @param data The data for the request.
* @param data.dagId
